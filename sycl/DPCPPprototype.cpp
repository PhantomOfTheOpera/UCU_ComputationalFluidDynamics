...
int main() {
    // Set constants
    constexpr size_t total_time = 200;
    ...
    static Tensor3D<double> q{}, fx{}, fy{}, fz{};
    static Tensor4D<double, params> U, corrector{}, predictor{};
    scl::range<3> num_items{ n, n, n };
    fillTensor4D<double, params>(U, std::array<double, params> {1.25, 0.0, 0.0, 0.0, 300.0});
